...
//			// "zip:http://datasets.openimaj.org/att_faces.zip",
...
//			//
//			//
//			// GroupedRandomSplitter<String, FImage> splits = new
//			// GroupedRandomSplitter<String, FImage>(dataset, nTraining,
//			// 0, nTesting);
//			// GroupedDataset<String, ListDataset<FImage>, FImage> training =
//			// splits.getTrainingDataset();
//			// GroupedDataset<String, ListDataset<FImage>, FImage> testing =
...
//		//
		...
		File testimagedir = new File("./Data/trainingset/faces__600_1200");
...
//					arfdataset.add(instance);
					...
					String destFolder = "./Data/trainingset/gender/";
					...
					FileUtils.copyFile(new File(propsAbsFileName), new File(destFolder + tf.getName().toString().substring(0,
							tf.getName().toString().length() - 4) + ".props"));
					input.close();
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
